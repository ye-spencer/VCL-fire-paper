...
import { $instruction_level, getFirstCooked, getFoodType, getSecondCooked } from "@/lib/store";
...
export default function Instruction() 
{
    ...
    {
        instruction = "Do you prefer to eat " + getFoodType().toLowerCase() + " " + getFirstCooked().toLowerCase() + " or " + getSecondCooked().toLowerCase() + "?";
    }
